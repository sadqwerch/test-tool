...
#include "../../../../softengine/bupt/master/monitorwindow.h"
...
QT_MOC_LITERAL(4, 30, 11) // "UpdateTable"

    },
    "MonitorWindow\0ChangeFreq\0\0val\0UpdateTable"
};
...
void MonitorWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ChangeFreq((*reinterpret_cast< int(*)>(_a[1]))); break;
